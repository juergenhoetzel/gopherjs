...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 811168557, time.UTC),
		},
		"/src": &vfsgen۰DirInfo{
			name:    "src",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 310537279, time.UTC),
		},
		"/src/bytes": &vfsgen۰DirInfo{
			name:    "bytes",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 768009062, time.UTC),
		},
		...
		"/src/bytes/bytes_test.go": &vfsgen۰CompressedFileInfo{
			name:             "bytes_test.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 768067658, time.UTC),
		...
		"/src/crypto": &vfsgen۰DirInfo{
			name:    "crypto",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 272714568, time.UTC),
		},
		"/src/crypto/rand": &vfsgen۰DirInfo{
			name:    "rand",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 272425742, time.UTC),
		},
		...
		"/src/crypto/x509": &vfsgen۰DirInfo{
			name:    "x509",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 273183889, time.UTC),
		},
		...
		"/src/database": &vfsgen۰DirInfo{
			name:    "database",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 273615324, time.UTC),
		},
		"/src/database/sql": &vfsgen۰DirInfo{
			name:    "sql",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 273661726, time.UTC),
		},
		"/src/database/sql/driver": &vfsgen۰DirInfo{
			name:    "driver",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 273733350, time.UTC),
		},
		...
		"/src/debug": &vfsgen۰DirInfo{
			name:    "debug",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 274294140, time.UTC),
		},
		"/src/debug/elf": &vfsgen۰DirInfo{
			name:    "elf",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 274357930, time.UTC),
		},
		...
		"/src/encoding": &vfsgen۰DirInfo{
			name:    "encoding",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 275294511, time.UTC),
		},
		"/src/encoding/gob": &vfsgen۰DirInfo{
			name:    "gob",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 274825912, time.UTC),
		},
		"/src/encoding/gob/gob_test.go": &vfsgen۰CompressedFileInfo{
			name:             "gob_test.go",
			modTime:          time.Date(2017, 10, 12, 19, 45, 13, 275175553, time.UTC),
		...
		"/src/encoding/json": &vfsgen۰DirInfo{
			name:    "json",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 275354048, time.UTC),
		},
		...
		"/src/fmt": &vfsgen۰DirInfo{
			name:    "fmt",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 275645874, time.UTC),
		},
		...
		"/src/go": &vfsgen۰DirInfo{
			name:    "go",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 275984752, time.UTC),
		},
		"/src/go/token": &vfsgen۰DirInfo{
			name:    "token",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 276046635, time.UTC),
		},
		...
		"/src/internal": &vfsgen۰DirInfo{
			name:    "internal",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 277025315, time.UTC),
		},
		"/src/internal/poll": &vfsgen۰DirInfo{
			name:    "poll",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 654800719, time.UTC),
		},
		"/src/internal/poll/fd_poll_js.go": &vfsgen۰CompressedFileInfo{
			name:             "fd_poll_js.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 654848893, time.UTC),
		...
		"/src/internal/testenv": &vfsgen۰DirInfo{
			name:    "testenv",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 277125360, time.UTC),
		},
		...
		"/src/io": &vfsgen۰DirInfo{
			name:    "io",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 277789831, time.UTC),
		},
		"/src/io/io_test.go": &vfsgen۰CompressedFileInfo{
			name:             "io_test.go",
			modTime:          time.Date(2017, 10, 12, 19, 45, 13, 278668224, time.UTC),
		...
		"/src/math": &vfsgen۰DirInfo{
			name:    "math",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 621022408, time.UTC),
		},
		"/src/math/big": &vfsgen۰DirInfo{
			name:    "big",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 279622420, time.UTC),
		},
		...
		"/src/math/math.go": &vfsgen۰CompressedFileInfo{
			name:             "math.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 621075221, time.UTC),
		...
		"/src/math/rand": &vfsgen۰DirInfo{
			name:    "rand",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 281891759, time.UTC),
		},
		...
		"/src/net": &vfsgen۰DirInfo{
			name:    "net",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 285348105, time.UTC),
		},
		"/src/net/http": &vfsgen۰DirInfo{
			name:    "http",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 284335607, time.UTC),
		},
		"/src/net/http/cookiejar": &vfsgen۰DirInfo{
			name:    "cookiejar",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 282799161, time.UTC),
		},
		...
		"/src/os": &vfsgen۰DirInfo{
			name:    "os",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 286676923, time.UTC),
		},
		...
		"/src/os/signal": &vfsgen۰DirInfo{
			name:    "signal",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 286772478, time.UTC),
		},
		...
		"/src/reflect": &vfsgen۰DirInfo{
			name:    "reflect",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 733742066, time.UTC),
		},
		...
		"/src/reflect/reflect.go": &vfsgen۰CompressedFileInfo{
			name:             "reflect.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 733819029, time.UTC),
		...
		"/src/reflect/reflect_test.go": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 699996541, time.UTC),
		...
		"/src/regexp": &vfsgen۰DirInfo{
			name:    "regexp",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 291841858, time.UTC),
		},
		...
		"/src/runtime": &vfsgen۰DirInfo{
			name:    "runtime",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 753129808, time.UTC),
		},
		"/src/runtime/debug": &vfsgen۰DirInfo{
			name:    "debug",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 292368227, time.UTC),
		},
		...
		"/src/runtime/pprof": &vfsgen۰DirInfo{
			name:    "pprof",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 293080036, time.UTC),
		},
		...
		"/src/runtime/runtime.go": &vfsgen۰CompressedFileInfo{
			name:             "runtime.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 753183814, time.UTC),
		...
		"/src/strings": &vfsgen۰DirInfo{
			name:    "strings",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 718893570, time.UTC),
		},
		"/src/strings/strings.go": &vfsgen۰CompressedFileInfo{
			name:             "strings.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 718954020, time.UTC),
		...
		"/src/sync": &vfsgen۰DirInfo{
			name:    "sync",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 725427048, time.UTC),
		},
		"/src/sync/atomic": &vfsgen۰DirInfo{
			name:    "atomic",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 295729372, time.UTC),
		},
		...
		"/src/sync/sync.go": &vfsgen۰CompressedFileInfo{
			name:             "sync.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 725478874, time.UTC),
		...
		"/src/syscall": &vfsgen۰DirInfo{
			name:    "syscall",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 760760353, time.UTC),
		},
		"/src/syscall/syscall.go": &vfsgen۰CompressedFileInfo{
			name:             "syscall.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 760231381, time.UTC),
		...
		"/src/syscall/syscall_linux.go": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 760442264, time.UTC),
		...
		"/src/syscall/syscall_nonlinux.go": &vfsgen۰FileInfo{
			...
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 760627613, time.UTC),
		...
		"/src/syscall/syscall_unix.go": &vfsgen۰CompressedFileInfo{
			...
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 760848235, time.UTC),
		...
		"/src/testing": &vfsgen۰DirInfo{
			name:    "testing",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 712728790, time.UTC),
		},
		...
		"/src/testing/testing.go": &vfsgen۰CompressedFileInfo{
			name:             "testing.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 712775963, time.UTC),
		...
		"/src/text": &vfsgen۰DirInfo{
			name:    "text",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 308224875, time.UTC),
		},
		"/src/text/template": &vfsgen۰DirInfo{
			name:    "template",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 308354171, time.UTC),
		},
		...
		"/src/time": &vfsgen۰DirInfo{
			name:    "time",
			modTime: time.Date(2018, 1, 25, 23, 45, 7, 627704665, time.UTC),
		},
		"/src/time/time.go": &vfsgen۰CompressedFileInfo{
			name:             "time.go",
			modTime:          time.Date(2018, 1, 25, 23, 45, 7, 627761463, time.UTC),
		...
		"/src/unicode": &vfsgen۰DirInfo{
			name:    "unicode",
			modTime: time.Date(2017, 10, 12, 19, 45, 13, 310634567, time.UTC),
		},
